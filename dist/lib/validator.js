...
var Validator = (function () {
    ...
    Validator.prototype.validateDate = function (date) {
        var pattern = /^(?:\d{4}\/(?:(?:(?:(?:0[13578]|1[02])\/(?:0[1-9]|[1-2][0-9]|3[01]))|(?:(?:0[469]|11)\/(?:0[1-9]|[1-2][0-9]|30))|(?:02\/(?:0[1-9]|1[0-9]|2[0-8]))))|(?:(?:\d{2}(?:0[48]|[2468][048]|[13579][26]))|(?:(?:[02468][048])|[13579][26])00)\/02\/29)$/;
     ...
     */
    Validator.prototype.validateMobileNumber = function (mobileNumber) {
        if (this.validateString(mobileNumber)) {
            var format = /^(\d{10})|(\(?([0-9]{3})\)?[-. ]?([0-9]{3})[-. ]?([0-9]{4}))|(\+?([0-9]{2})\)?[-. ]?([0-9]{4})[-. ]?([0-9]{4}))$/;
     ...
     */
    Validator.prototype.validateCreditCardNumber = function (creditCardNumber) {
        if (this.validateString(creditCardNumber)) {
            var format = /^(?:3[47][0-9]{13})|(?:4[0-9]{12}(?:[0-9]{3})?)|(?:5[1-5][0-9]{14})|((?:6(?:011|5[0-9][0-9])[0-9]{12}))|((?:3(?:0[0-5]|[68][0-9])[0-9]{11}))$/;
